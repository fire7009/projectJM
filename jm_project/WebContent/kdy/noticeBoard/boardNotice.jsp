...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	int totalBoard=NoticeInfoDAO.getDAO().selectNoticeCount(search, keyword);
	...
	List<NoticeInfoDTO> boardList=No.getDAO().selectNoticeBoard(startRow, endRow, search, keyword);
